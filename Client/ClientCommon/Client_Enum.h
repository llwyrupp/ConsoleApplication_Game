...
enum class E_BATTLESEQUENCE {
	E_BATTLESEQUENCE_WAITFORINPUT = -1,
	...
	E_BATTLESEQUENCE_ESCAPE = 5,
	E_BATTLESEQUENCE_COMPLETE = 6,
	E_BATTLESEQUENCE_MAX
};
#pragma endregion BATTLESEQUENCE

#pragma region PLAYERACTION
enum class E_PLAYERACTION {
	E_PLAYERACTION_NONE = -1,
	E_PLAYERACTION_ATTACK = 0,
	E_PLAYERACTION_GUARD = 1,
	E_PLAYERACTION_SELECTITEM = 2,
	E_PLAYERACTION_RUN = 3,
	E_PLAYERACTION_USEITEM = 4,
	E_PLAYERACTION_MAX
};
#pragma endregion PLAYERACTION

#pragma region ENEMYSTATE
enum class E_ENEMYSTATE {
	E_ENEMYSTATE_NONE = -1,
	E_ENEMYSTATE_ATTACK = 0,
	E_ENEMYSTATE_GUARD = 1,
	E_ENEMYSTATE_NOHIT = 2,
	E_ENEMYSTATE_HIT = 3,
	E_ENEMYSTATE_MAX
};
