...
#pragma region BATTLESEQUENCE

enum class E_BATTLESEQUENCE {
	E_BATTLESEQUENCE_NONE = -1,
	E_BATTLESEQUENCE_PLAYERACTION = 0,
	E_BATTLESEQUENCE_ENEMYHIT = 1,
	E_BATTLESEQUENCE_INTERMISSION = 2,
	E_BATTLESEQUENCE_ENEMYACTION = 3,
	E_BATTLESEQUENCE_PLAYERHIT = 4,
	E_LEVELTYPE_MAX
};

#pragma endregion BATTLESEQUENCE
